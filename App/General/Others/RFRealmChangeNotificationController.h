//
//  RFRealmChangeNotificationController.h
//  Feel
//
//  Created by BB9z on 5/13/16.
...
@property (nonatomic, nullable, strong) id<RLMCollection> collection;
...
/// 未设置，变更操作在主线程
@property (nonatomic, nullable, strong) dispatch_queue_t changeHandlerQueue;
